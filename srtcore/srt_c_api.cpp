...
int srt_connect(SRTSOCKET u, const struct sockaddr * name, int namelen, from_addr_cb const& addr_cb) { return CUDT::connect(u, name, namelen, 0, addr_cb); }
int srt_connect_debug(SRTSOCKET u, const struct sockaddr * name, int namelen, int32_t forced_isn) { return CUDT::connect(u, name, namelen, forced_isn, nullptr); }
        ...
        const struct sockaddr* remote_name, int remote_namelen)
{
    ...
    return srt_connect(u, remote_name, remote_namelen, nullptr);
}
